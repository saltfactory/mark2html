...
//    logger.error('src 값이 없습니다. markdown 파일의 경로를 지정해주세요.');
    logger.error('[ERROR] : "src" value is not exists!');
...
//    logger.error('destDir 값이 없습니다. html 파일의 저장될 디렉토리를 지정해주세요.');
    logger.error('[ERROR] : "destDir" value is not exists!');
